...
|-----|---------|---------|-------|------------|--------|-------|
| 1 | Jacob Wells | GiveSendGo | email | pipeline/emails/01-givesendgo-jacob-wells.md | awaiting-send (2026-06-12) | Gmail draft r5024590629102227397 (v2 w/ timing close; discard old r2549293249150224976); addr: jacob@givesendgo.com (guessed, LinkedIn DM fallback); operator-approved final copy |
| 2 | Steve Gatena | Pray.com | email | pipeline/emails/02-pray-com-steve-gatena.md | awaiting-send (2026-06-12) | Gmail draft r-2512067069567764677 (v2 w/ timing close; discard old r4423381822718947767); addr: steve.gatena@pray.com (first.last house pattern); DC July 2-5 meet angle; Matt Potter is the fallback door |
| 3 | David Santrella | Salem Media | email | pipeline/emails/03-salem-media-david-santrella.md | awaiting-send (2026-06-12) | Gmail draft r1786079167904553097; addr: david@salemmedia.com (firstname@ pattern); streamlined intro-call ask w/ Thu/Fri windows; operator-approved final copy |
