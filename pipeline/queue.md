...
| 4 | Steve Smith | Newsmax | email | pipeline/emails/08-newsmax-steve-smith.md | awaiting-send (2026-06-12) | Gmail draft r6460335793631241751; addr: steves@newsmax.com (60.6% pattern; ladder ssmith@, steve.smith@); ask broadened to general intro call (AI automation, not T&S) per operator; operator-approved final copy |
| 5 | Erich Kerekes | Hallow | email | pipeline/emails/05-hallow-erich-kerekes.md | awaiting-send (2026-06-12) | Gmail draft r9169419190293101814; addr: erich@hallow.app (domain is hallow.app NOT hallow.com; first-name = 90.9% pattern); Brand hearings Jun 16-17 — send by Mon; operator-approved final copy |
