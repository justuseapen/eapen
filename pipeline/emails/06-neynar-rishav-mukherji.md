# Neynar — Rishav Mukherji (CEO & Co-founder)

**To:** Rishav Mukherji (try rish@neynar.com or rishav@neynar.com)
**From:** justus@eapentechnology.com
**Subject:** Re: inheriting Farcaster
...
I spent five years on Truth Social's internal trust and safety infrastructure at TMTG. Different stack, same core problem: App Store accommodation without policy capture.

I run Eapen Technology separately from TMTG. Taking on two clients this quarter. If you have thirty minutes in the next two weeks, I'd like to talk about how the policy layer changes when the protocol is decentralized but the client is not.
...
- Risk: "policy capture" is a term-of-art that may read academic to a Web3 founder. Alternative phrasing: "without letting the policy team drift back to Bay Area defaults." Justus's call on which voice.
