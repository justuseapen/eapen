...
- FINAL, operator-approved 2026-06-11; timing close added 2026-06-12 per operator (assume the close, offer windows). Gmail draft id r6130825168285138709 (v3, HTML body) in the justus@eapentechnology.com mailbox — supersedes r5024590629102227397 and r2549293249150224976; operator must discard the older drafts.
- v3 lesson: plain-text drafts get auto-linkified by Gmail, which pastes its google.com/url redirect wrapper in as the VISIBLE signature text. Always create drafts with htmlBody and an explicit anchor for the signature link.
