...
- **Parler.** Do not depend on AWS or any infrastructure layer run by people who would gladly destroy you.
- **Gab.** Total refusal is a coherent choice. Its price is permanent smallness.
- **Rumble.** The middle path works if you own the core, diversify the commodity, and accept the minimum app-store accommodation.
- **Telegram.** Opacity buys latitude. It is not a strategy a Western founder can pursue openly.
